...
public class Ventana extends javax.swing.JFrame {
    ...
    private void adicionarProducto() {
        if (txtNombre.getText().isEmpty() || txtNumero.getText().isEmpty()) {
            ...
            if (r) {
                JOptionPane.showMessageDialog(this, "Se Almaceno el contacto", "Atencion", JOptionPane.INFORMATION_MESSAGE);
                cargarDatos();
                limpiar();

            } else {
                JOptionPane.showMessageDialog(this, "No se almaceno el contacto", "Atencion", JOptionPane.ERROR_MESSAGE);
            }
        }
    }
    ...
    public void vnParrilla(){
        VentanaParrilla p = new VentanaParrilla();
        p.setVisible(true);
