...
public class VentanaParrilla extends javax.swing.JFrame {
    ...
    private void adicionarProducto() {
        if (txtNombre.getText().isEmpty() || txtHoraInicio.getText().isEmpty() || txtFecha.getText().isEmpty() || txtHoraFinal.getText().isEmpty()) {
            JOptionPane.showMessageDialog(this, "Por favor! No dejar campos vacios");
        } else {
            String nombre = txtNombre.getText();
            String cantidad = txtHoraInicio.getText();
            String marca = txtFecha.getText();
    ...
    private void seleccionarProducto() {
        ...
        this.txtHoraInicio.setText(productoseleccionado.getFechaTransmision());
        this.txtFecha.setText(productoseleccionado.getHoraInicio());
